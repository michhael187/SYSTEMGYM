...
<body>
    @php
        ...
        $proximoCliente = $clientesColeccion
            ->filter(fn ($cliente) => $cliente->fecha_vencimiento !== null)
            ->sortBy('fecha_vencimiento')
            ->first();

        $proximaFecha = $proximoCliente?->fecha_vencimiento;
    ...
    <div class="page-footer">
        SystemGym - Informe de clientes vigentes |
        Fecha de referencia {{ $fecha_referencia->format('d/m/Y') }}
        <span style="float: right;">Página <span class="page-number"></span></span>
    </div>

    <div class="header">
        <h1 class="brand-title">Informe de Clientes Vigentes</h1>

        <div class="brand-subtitle">
            Reporte de clientes activos con membresía vigente.
        </div>
    ...
    <div class="cards">
        ...
        <div class="card">
            <div class="label">Clientes vigentes</div>
            <div class="value">{{ $total_clientes_vigentes }}</div>
            <div class="helper">Activos con cuota vigente</div>
        </div>
    ...
    <div class="section">
        ...
        <div class="summary-box">
            ...
            <strong>{{ $total_clientes_vigentes }}</strong> clientes activos con membresía vigente.
            La membresía con mayor participación es
    ...
    <div class="section">
        <h2 class="section-title">Detalle de clientes vigentes</h2>

        <p class="section-note">
            Listado de clientes activos cuya fecha de vencimiento no se encuentra vencida.
        </p>

        @if ($clientesColeccion->isEmpty())
        ...
        @else
            <table class="table">
                ...
                <tbody>
                    @foreach ($clientesColeccion as $cliente)
                        <tr>
