<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8 rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800 to-slate-700 p-8 text-white shadow-xl">
                ...
                <div class="mt-4 inline-flex rounded-full bg-white/10 px-4 py-2 text-sm">
            ...
            <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                @can('update', App\Models\User::class)
                    <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        ...
                        <div class="mt-6 flex flex-col gap-3">
                            <a href="{{ route('usuarios.create') }}" class="rounded-lg bg-slate-900 px-4 py-3 text-center text-sm font-medium text-white">
                ...
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="mt-6 flex flex-col gap-3">
                        <a href="{{ route('clientes.create') }}" class="rounded-lg bg-slate-900 px-4 py-3 text-center text-sm font-medium text-white">
                ...
                @can('create', App\Models\Membresia::class)
                    <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        ...
                        <div class="mt-6 flex flex-col gap-3">
                            <a href="{{ route('membresias.create') }}" class="rounded-lg bg-slate-900 px-4 py-3 text-center text-sm font-medium text-white">
                ...
                @can('create', App\Models\Pago::class)
                    <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        ...
                        <div class="mt-6 flex flex-col gap-3">
                            <a href="{{ route('pagos.create') }}" class="rounded-lg bg-slate-900 px-4 py-3 text-center text-sm font-medium text-white">
