                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        <div class="flex items-center justify-between">
                            ...
                            @if (Route::has('password.request'))
                                <a class="text-xs font-semibold text-blue-600 transition hover:text-blue-500" href="{{ route('password.request') }}">
                                    ¿Olvidaste tu clave?
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="flex items-center justify-between pt-1">
                        <div class="flex items-center">
                            ...
                            >
                            <label for="remember_me" class="ml-2 block select-none text-sm font-medium text-slate-600">
